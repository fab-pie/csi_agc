...
#define CONFIG_PARTITION_TABLE_CUSTOM_FILENAME "components/zoefall_rx/partitions.csv"
#define CONFIG_PARTITION_TABLE_FILENAME "components/zoefall_rx/partitions.csv"
...
#define CONFIG_ESP_WIFI_DYNAMIC_RX_BUFFER_NUM 85
