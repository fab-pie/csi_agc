...
#define CONFIG_PARTITION_TABLE_CUSTOM_FILENAME "components/zoefall_tx/partitions.csv"
#define CONFIG_PARTITION_TABLE_FILENAME "components/zoefall_tx/partitions.csv"
